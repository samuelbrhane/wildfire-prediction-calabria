# Zone-level hyperparameter tuning for Transformer
import os
import sys
import random
import numpy as np
...
for zone_id in range(1, 9):
    print(f"\n=== Tuning Transformer for Zone {zone_id} ===")

    results_csv_path = os.path.join(RESULTS_DIR, f"zone_{zone_id}_transformer_results.csv")
...
print("\nAll Transformer zone tuning complete.")