# Regional-level hyperparameter tuning for XGBoost
import os
import sys
import random
import numpy as np
...
results_csv_path = os.path.join(RESULTS_DIR, f"{GROUP_NAME}_xgboost_results.csv")
...
print(f"\nTuning complete for regional XGBoost model — results saved to {results_csv_path}")