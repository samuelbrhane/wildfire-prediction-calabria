# Zone-level model selection and evaluation for XGBoost
import os
import sys
import numpy as np
...
def predict_fn(model, X_test, y_test, df_test, scaler_y=None):
    # Predict and compute residuals for XGBoost
...
for zone_id in range(1, 9):
    ...
    result_file = os.path.join(RESULTS_DIR, f"zone_{zone_id}_xgboost_results.csv")
...
print("\nAll XGBoost zone model selection complete.")